...
function renderProfile() {
  ...
  container.innerHTML = `
    ...
    <div class="fade-up-1" style="padding:24px 0 20px">
        <div style="display:flex;align-items:center;gap:14px">
            ...
            <div>
                ...
                <p style="font-size:13px;color:var(--subtext);margin-top:3px">${formatStudentId(STUDENT.studentId)} · ${STUDENT.course}</p>
    ...
    <div class="card fade-up-2" style="margin-bottom:14px">
        ...
        ${pRow('Student ID', formatStudentId(STUDENT.studentId))}
        <div class="divider" style="margin:8px 0"></div>
